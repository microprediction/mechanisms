...
The multivariate, continuous-time face of the same growth idea is **stochastic
portfolio theory** (Fernholz 2002; Fernholz & Karatzas 2009): the Kelly /
growth-optimal portfolio is SPT's *numéraire portfolio*, and SPT decomposes
long-run log-growth into the weighted asset returns plus an *excess growth rate*
generated by volatility and diversity (the "volatility drag"). A gentle
introduction, and its inverse, is at
https://microprediction.medium.com/a-gentle-introduction-to-stochastic-portfolio-theory-and-its-inverse-241d3bc72917
